...
if nargin < 1
    ...
    mex_dir_name    =   opts.mexDirName;
end


root = vl_rootnn() ;
addpath(fullfile(root, 'matlab')) ;
addpath(fullfile(root, 'matlab', mex_dir_name)) ;
...
if numel(dir(fullfile(root, 'matlab', mex_dir_name, 'vl_nnconv.mex*'))) == 0
